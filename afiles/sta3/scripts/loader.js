...
(function (Promise) {
   ...
   function IALoader(canvas, game, callbacks, scale) {
     ...
     function loadFiles(fetch_file, splash) {
       splash.setTitle("Loading game metadata...");
       return new Promise(function (resolve, reject) {
                            ...
                            loading.then(function (data) {
                                           metadata = data;
                                           splash.setTitle("Loading game filelist...");
                                           return fetch_file('Game File List',
                                                             get_files_url(game),
                                                             'document', true);
                                         },
                                         function () {
                                           splash.setTitle("Failed to load IA item metadata!");
                                   ...
                                   .then(function (data) {
                                           ...
                                           filelist = data;
                                           splash.setTitle("Loading emulator metadata...");
                                         ...
                                         function () {
                                           ...
                                           splash.setTitle("Failed to load file list!");
                                           splash.failed_loading = true;
                                           reject(2);
                                         })
                                   .then(function (data) {
                                           ...
                                           splash.setTitle("Loading game data...");
                                         ...
                                         function () {
                                           ...
                                           splash.setTitle("Failed to load emulator metadata!");
                                           splash.failed_loading = true;
                                           reject(2);
                                         })
     ...
     var get_cors_url = function(item, path) {
       ...
       return './cors_server/' + item + (path ? '/' + path : '');
     }
